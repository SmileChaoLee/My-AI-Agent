...
CODE_MODEL = 'openai/gpt-oss-20b:free'
...
analyzing code,reading files that are written in code, and
answering questions about programming languages and software development. 
"""
